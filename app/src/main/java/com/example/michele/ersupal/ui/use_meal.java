...
public class use_meal extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.uhome) {
            Intent useIntent = new Intent(this, menu_principale.class);
            this.startActivity(useIntent);
        } else if (id == R.id.unews) {
            Intent useIntent = new Intent(this, News_activity.class);
            this.startActivity(useIntent);

        } else if (id == R.id.umoduli) {
            Intent useIntent = new Intent(this, Moduli_activity.class);
            this.startActivity(useIntent);
        }
