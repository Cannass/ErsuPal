...
import com.example.michele.ersupal.adapter.DerpAdapter;
...
public class News_activity extends AppCompatActivity implements DerpAdapter.ItemClickCallback {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nhome) {
            Intent newsintent = new Intent(this, menu_principale.class);
            this.startActivity(newsintent);
        } else if (id == R.id.nmoduli) {
            Intent newsintent = new Intent(this, Moduli_activity.class);
            this.startActivity(newsintent);
        }
    ...
    public void onItemClick(int p) {
        ...
        extras.putString(EXTRA_NEWS,item.getNews());
    ...
    public void onSecondaryIconClick(int p) {
        ...
        if (item.isFavoutire()){
            item.setFavoutire(false);
        }else{
            item.setFavoutire(true);
        }
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("News_activity Page") // TODO: Define a title for the content shown.
